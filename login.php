...
<head>
  ...
  <link rel="shortcut icon" href="{{ asset ('assets/dist/img/bajarmasin.png') }}">
  <title>Login | UMKM KOTA BANJARMASIN</title>
  <!-- Tell the browser to be responsive to screen width -->
  <meta name="viewport" content="width=device-width, initial-scale=1">

  <link rel="shortcut icon" href="<?= base_url() ?>/assets/dist/img/bajarmasin.png">
  <!-- Font Awesome -->
  ...
  <div class="login-box">
    ...
    <div class="card">
      <div class="login-logo">
        <br>
        <h4 style="color:black; font-family:Impact, Charcoal, sans-serif">Aplikasi Pendataan UMKM Kota Banjarmasin<br></h4>
        <h3>
