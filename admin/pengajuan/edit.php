...
<body class="hold-transition sidebar-mini layout-fixed">
                                ...
                                <div class="card card-dark">
                                    ...
                                    <div class="card-body" style="background-color: white;">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control" id="nama_umkm" name="nama_umkm" value="<?= $row['nama_umkm'] ?>">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label for="ket" class="col-sm-2 col-form-label">Keterangan</label>
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control" id="ket" name="ket" value="<?= $row['ket'] ?>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control" id="longInput" name="long" value="<?= $row['long'] ?>">
                                            </div>
                                        </div>
    ...
    if (isset($_POST['submit'])) {
        ...
        $submit = $koneksi->query("UPDATE pengajuan SET 
        nama_umkm = '$nama_umkm', 
        ket = '$ket',
        lat = '$lat',
        lang = '$lang',
